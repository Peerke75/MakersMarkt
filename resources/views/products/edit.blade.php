        ...
        <form action="{{ route('products.update', $product->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <select name="material" id="material"
                        ...
                        <option value="kunststof" {{ old('material') == 'kunststof' ? 'selected' : '' }}>Kunststof</option>
            ...
            <div>
                ...
                <select name="production_time" id="production_time"
                    ...
                    <option value="1-3 maanden" {{ old('production_time') == '1-3 maanden' ? 'selected' : '' }}>1-3 maanden</option>
                    <option value="4-6 maanden" {{ old('production_time') == '4-6 maanden' ? 'selected' : '' }}>4-6 maanden</option>
                    <option value="7-9 maanden" {{ old('production_time') == '7-9 maanden' ? 'selected' : '' }}>7-9 maanden</option>
                    <option value="10-12 maanden" {{ old('production_time') == '10-12 maanden' ? 'selected' : '' }}>10-12 maanden</option>
                </select>
            </div>
